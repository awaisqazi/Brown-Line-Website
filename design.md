...
- Stop colors: Maya Blue → Celadon → Amber → Cayenne (Events, Archive, About, Ethics). `--route-gap` is 5rem at `lg` (comfortable, centered spacing); `--route-pad` reserves room for the first/last labels so they clear the logo and the CTA cluster.
